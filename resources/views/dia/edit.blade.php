            ...
            <div class="intro-y col-span-12 lg:col-span-6">
                <form method="POST" action="{{route('dia.update',$dia->iddia)}}">
                    ...
                    <div class="form-group">
                        <label >CÓDIGO:</label>
                        <input class="form-control" type="text" id="id" name="id" value="{{$dia->iddia}}" disabled/>
                    </div><br>
                    <div class="form-group">
                        <label >DÍA:</label>
                        <input class="form-control @error('descripcion') is-invalid @enderror" type="text"
                                placeholder="Ingrese día" id="descripcion" name="descripcion" value="{{$dia->descripcion}}"/>
                            @error('descripcion')

...
<html lang="en" class="light">
    ...
    <body class="login">
            ...
            <div class="block xl:grid grid-cols-2 gap-4">
                ...
                <div  class="hidden xl:flex flex-col min-h-screen" >
                    <a href="" class="-intro-x flex items-center pt-5">
                        <img alt="Midone - HTML Admin Template" class="w-6" src="dist/images/logo.jpg">
                        <span class="text-white text-lg ml-3"> Poseidón </span> 
                    </a>
                
                    <div class="my-auto" >
                        <img alt="Midone - HTML Admin Template" class="-intro-x w-1/2 -mt-16" src="dist/images/logo.jpg">
                        ...
                        <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">
                            Administre todas sus cuentas en un solo lugar</div>
                    </div>
                </div>
                <!-- END: Login Info -->
                <!-- BEGIN: Login Form -->
                            ...
                            @csrf
                                ...
                                <div class="intro-x mt-8">
                                    ...
                                    <span class="invalid-feedback" role="alert">
                                        ...
                                        <audio src="2.wav" autoplay ></audio>
                                    </span>
                                    @enderror
                                ...
                                <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left" class="form-actions">
        ...
        <div data-url="dark" class="dark-mode-switcher cursor-pointer shadow-md fixed bottom-0 right-0 box border rounded-full w-40 h-12 flex items-center justify-center z-50 mb-10 mr-10">

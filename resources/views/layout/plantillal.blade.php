...
<html lang="en" class="light">
    ...
    <head>
        ...
        <link rel="stylesheet" href="/dist/css/_app.css">
        {{-- <link href="/../build/css/custom.min.css" rel="stylesheet"> --}}
        <link href="/assets/css/them.min.css" rel="stylesheet">
        <!-- END: CSS Assets-->
    </head>
    <!-- END: Head -->
            ...
            <ul class="border-t border-white/[0.08] py-5 hidden">
                <li>
                    <a href="javascript:;.html" class="menu menu--active">
                        ...
                        <div class="menu__title"> Mantenedor<i data-lucide="chevron-down" class="menu__sub-icon transform rotate-180"></i> </div>
                    </a>
                    <ul class="menu__sub-open">
                        <li>
                            <a href="{{route('alumno.index')}}" class="menu">
                                <div class="menu__icon"> <i class="fa-thin fa-chalkboard-user"></i> </div>
                                <div class="menu__title"> Alumnos </div>
                            </a>
                        </li>
                        <li>
                            <a href="side-menu-light-dashboard-overview-2.html" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu__title"> Cargo </div>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="index.html" class="menu menu--active">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu__title"> PRUEBAAAAAAA</div>
                            </a>
                        </li> 
                    </ul>
                </li>
                    ...
                    <ul class="">
                        <li>
                            <a href="side-menu-light-dashboard-overview-1.html" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu__title"> Días </div>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('horario.index')}}" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu__title"> Turnos </div>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript:;.html" class="menu menu--active">
                        <div class="menu__icon"> <i data-lucide="home"></i> </div>
                        <div class="menu__title"> Programacion<i data-lucide="chevron-down" class="menu__sub-icon transform rotate-180"></i> </div>
                    </a>
                    <ul class="menu__sub-open">
                        <li>
                            <a href="{{route('alumno.index')}}" class="menu">
                                <div class="menu__icon"> <i class="fa-thin fa-chalkboard-user"></i> </div>
                                <div class="menu__title"> Piscina </div>
                            </a>
                        </li>
                        <li>
                            <a href="side-menu-light-dashboard-overview-2.html" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu__title"> Nivel </div>
                            </a>
                        </li>
                        <li>
                            <a href="side-menu-light-dashboard-overview-3.html" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu__title"> Programaciòn</div>
                            </a>
                        </li>
                        {{-- <li>
                            <a href="index.html" class="menu menu--active">
            ...
            <div class="h-full flex items-center">
                ...
                <div class="intro-x dropdown w-8 h-8">
                    <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in scale-110" role="button" aria-expanded="false" data-tw-toggle="dropdown">
                        <img alt="Midone - HTML Admin Template" src="https://c.tenor.com/UOh324ioh8MAAAAC/the-little-mermaid-png-by-fernando-la-sirenita-png.gif">
                    </div>
                ...
                <ul>
                    <li>
                        ...
                        <ul class="side-menu__sub-open">
                            <li>
                                <a href="{{route('alumno.index')}}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="credit-card"></i> </div>
                                    <div class="side-menu__title"> Alumnos </div>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('cargo.index')}}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="credit-card"></i> </div>
                                    <div class="side-menu__title"> Cargo </div>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('personal.index')}}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="credit-card"></i> </div>
                                    <div class="side-menu__title"> Personal </div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="">
                            <li>
                                <a href="{{route('dia.index')}}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="hard-drive"></i> </div>
                                    <div class="side-menu__title"> Días </div>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('horario.index')}}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="hard-drive"></i> </div>
                                    <div class="side-menu__title"> Turnos </div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="side-menu__sub-open">
                            <li>
                                <a href="{{route('piscina.index')}}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                    <div class="side-menu__title"> Piscina </div>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('nivel.index')}}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                    <div class="side-menu__title"> Nivel </div>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                    <div class="side-menu__title"> Programación de Clase</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="side-menu__sub-open">
                            <li>
                                <a href="" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                    <div class="side-menu__title"> Montos </div>
                                </a>
                            </li>
                            <li>
                                <a href="" class="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="side-menu__sub-open">
                            <li>
                                <a href="{{route('matricula.index')}}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                    <div class="side-menu__title"> Registrar Matrículas </div>
                                </a>
                            </li>
                            <li>
                                <a href="" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                    <div class="side-menu__title"> Modificar Matrículas </div>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                    <div class="side-menu__title"> Consultar Matrículas</div>
                                </a>
                            </li>
                        </ul>
                    </li>

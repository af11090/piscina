              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="dashboard">
                    <li class="nav-item"><a class="nav-link" href="{{route('personal.index')}}" aria-expanded="false">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../dashboard/saas.html" aria-expanded="false">

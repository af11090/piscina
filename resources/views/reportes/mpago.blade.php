            ...
            <div id="invoice">
                ...
                <div class="invoice overflow-auto">
                    <div style="min-width: 600px">
                        ...
                        <main>
                            <div class="row contacts">
                                <div class="col invoice-details">
                                    ...
                                    <h1 class="invoice-id">REPORTE MATRICULAS POR FORMA DE PAGO - {{$S}}</h1>
                            ...
                            <table class="table table-report -mt-2">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center whitespace-nowrap">FORMA PAGO</th>
                                ...
                                <tbody>
                                        ...
                                        @if ($itemmatricula->PAGO->idpago=="1")
                                        ...
                                        <br> <tfoot >
                                            <tr>
                                                ...
                                                <td colspan="11"> MONTO TOTAL EN EFECTIVO</td>
                                                <td>S/ {{$P}}</td>
                                                <td colspan="2"></td> 
                                            </tr>
                                        </tfoot>
                        ...
                        @endphp
                          <h1>TARJETA</h1>
                            <table class="table table-report -mt-2">
                                ...
                                <tbody>
                                        @foreach($matricula as $itemmatricula)
                                        @if ($itemmatricula->PAGO->idpago=="2")
                                        ...
                                        <br> <tfoot >
                                            <tr>
                                                ...
                                                <td colspan="11"> MONTO TOTAL CON TARJETA</td>
                                                <td>S/ {{$P}}</td>
                                                <td colspan="2"></td> 
                                            </tr>
                                        </tfoot>
                        ...
                        <footer>Reportes Reportes 2022 Piscina Poseidon</footer>
                    </div>

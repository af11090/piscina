            ...
            <div id="invoice">
                ...
                <div class="invoice overflow-auto">
                    <div style="min-width: 600px">
                        ...
                        <main>
                            <div class="row contacts">
                                <div class="col invoice-details">
                                    ...
                                    <h1 class="invoice-id">REPORTE DE CAJA DIARIA - {{$S}}</h1>
                            ...
                            <table class="table table-report -mt-2">
                                ...
                                <tbody>
                                        ...
                                        @if ($itemmatricula->fecha==$DateAndTime)
                                        ...
                                        <br> <tfoot >
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="11">MONTO TOTAL DIARIO</td>
                                                <td>S/ {{$P}}</td>
                                            </tr>
                                        </tfoot>
                                </tbody>
                        ...
                        <footer>Reportes Diario Piscina Poseidón</footer>
                    </div>
